...
<!-- Section Intro Start -->
<section class="Pricing_Plans intro">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="section-title pt-5">
                    <span class="h6 text-color ">Pricing And Plans</span>
                    <h2 class="mt-3">Our services are tailored for you by professional experts, All goodies that you
                        expect for best grades </h2>
                </div>
            </div>
